    ...
    <div class="container px-4 py-10 mx-auto">
      <div class="lg:flex lg:items-center">
        <div class=" space-y-12 lg:w-1/2 ">
          <div>
            <h1 class="text-3xl font-semibold text-base-100 capitalize lg:text-4xl" >explore our <br>
              awesome Components</h1>

            <div class="mt-2">
              <span class="inline-block w-40 h-1 rounded-full bg-neutral"></span>
              <span class="inline-block w-3 h-1 ml-1 rounded-full bg-secondary"></span>
          ...
          <div class="md:flex md:items-start md:-mx-4">
            ...
            <div class="mt-1 md:mx-4 md:mt-0">
