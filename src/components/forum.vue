<template>
<div class="min-h-screen bg-gradient-to-tr from-primary to-secondary flex justify-center items-center py-20">
  <div class="md:px-2 md:grid md:grid-cols-2 lg:grid-cols-3 gap-5 space-y-8 md:space-y-0">

    <div class="max-w-sm px-4 pt-4 pb-2">
      <h3 class="mb-3 text-xm font-semibold text-base-100">Welcome Guys.</h3>
      <h1 class="mt-6 text-gray-800 text-3xl font-bold cursor-pointer">Javascript Bootcamp for Absolute Beginners</h1>
      <div class="my-4">
    ...
    <!-- Beginner Friendly -->
    <div class="max-w-sm bg-accent px-4 pt-4 pb-2 rounded-xl shadow-lg transform hover:scale-105 transition duration-500">
